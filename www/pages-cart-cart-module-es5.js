...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cart-cart-module"], {
  ...
  function srcAppPagesCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(firebase, router) {
      ...
      _createClass(CartPage, [{
        ...
        value: function calcularPago() {
          ...
          this.products.forEach(function (prod) {
            if (prod.producto.descuento != 0) {
              _this4.total += (prod.producto.precio - prod.producto.precio * (prod.producto.descuento / 100)) * prod.cantidad;
            } else {
              _this4.total += prod.producto.precio * prod.cantidad;
            }
          });
          return this.total;
        }
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_firebase_service__WEBPACK_IMPORTED_MODULE_3__["FirebaseService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], CartPage);
    /***/
  }
}]);
