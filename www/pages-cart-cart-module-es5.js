...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cart-cart-module"], {
  ...
  function srcAppPagesCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_unique_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(firebase, router, cartService, distanceService, idunico) {
      ...
      _createClass(CartPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    prodPedido = JSON.parse(localStorage.getItem("APP_PEDIDO"));
                    ...
                    this.firebase.obtener("transversal").subscribe(function (t) {
                      if (t[0].descuento > 0) {
                        _this.discount = t[0].descuento;
                      }

                      if (t[0].obsequios) {
                        _this.obsequios = t[0].obsequios;
                        _this.obserquioSiempre = t[0].obsequioinicial;

                        _this.obtenerObssequios();
                      }

                      if (t[0].opcionespago) {
                        _this.formapago = t[0].opcionespago;
                      }

                      if (t[0].domicilios) {
                        _this.domicilios = t[0].domicilios;
                      }
                    });
                    this.firebase.obtener('usuarios').subscribe(function (user) {
                      _this.store = user[0];
                    });
                    this.verificarDescuentoProductos(); //this.actualizarInventario();
        ...
        value: function asignarProductos() {
          ...
          console.log(this.products); // this.productsTemp = JSON.parse(JSON.stringify(this.productsGrl))
        }
      }, {
        key: "irAtras",
        ...
        value: function aplicarDesctuentoTienda() {
          ...
          this.products.forEach(function (prod) {
            prod.producto.descuento = _this3.discount;
          });
        }
      }, {
        key: "aplicarDesctuentoTransversal",
        value: function aplicarDesctuentoTransversal() {
          var _this4 = this;

          this.products.forEach(function (prod) {
            prod.producto.descuento = _this4.verificarDesceunto[0].valor;
          });
        }
      }, {
        ...
        value: function obtenerObssequios() {
          ...
          var index = this.obsequios.findIndex(function (data) {
            return _this6.total >= data.desde && _this6.total <= data.hasta && data.hasta != 999999999;
          });
        ...
        value: function domicilio() {
          this.verificarDomicilio = this.obsequiosShow.filter(function (o) {
        ...
        key: "calcularDomicilio",
        value: function calcularDomicilio() {
          var valorRetorno = 0;
          var distancia = this.distanceService.difereciaEntreDosPuntos(this.store.lon, this.store.lat, this.gps.lon, this.gps.lat); //let distancia = this.distanceService.difereciaEntreDosPuntos(-73.2857307, 10.494702, -73.2295297, 10.444309);

          var distanciaMetros = parseFloat(distancia) * 1000;
          this.domicilios.forEach(function (dom) {
        ...
        key: "closeDescuento",
        value: function closeDescuento(e) {
          this.showDescuentos = e;
        }
      }, {
        key: "closeModalFormaPAgo",
        value: function closeModalFormaPAgo(e) {
        ...
        value: function quitarProducto(product) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this7.productsGrl.splice(product, 1);

              _this7.asignarProductos();

              _this7.domicilio();

              _this7.cartService.administrarProducto(_this7.productsGrl);

              _this7.obtenerObssequios();
            }
          });
        }
      }, {
        ...
        value: function finalizarPedido() {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this8.guardarPedido();

              _this8.showFormaPago = true;
            }
          });
        }
      }, {
        ...
        value: function guardarPedido() {
          ...
          var fecha = dd + '/' + mm + '/' + yyyy; // console.log(this.products);
          ...
          this.firebase.guardarDatos('pedidos', pedido).then(function () {
            _this9.actualizarInventario();

            _this9.cartService.vaciarCarrito();

            _this9.productsGrl = [];

            _this9.asignarProductos();

            _this9.domicilio();

            _this9.obtenerObssequios();
        ...
        key: "cargandoDomicilio",
        value: function cargandoDomicilio() {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    fecha = this.distanceService.fechaActual();
                        ...
                        return regeneratorRuntime.wrap(function _callee2$(_context2) {
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                _context2.next = 2;
                                return this.firebase.obtenerUniqueIdPromise("productos", product.producto.idunico);
                              ...
                              case 2:
                                ...
                                console.log(prod[0]);
                                _context2.next = 8;
                                return this.firebase.actualizarDatos("productos", prod[0], prod[0].id);

                              case 8:
                                _context2.next = 10;
                                return this.firebase.guardarDatos("movimientos", {
                                  producto: prod[0],
                                  movimiento: "SALIDA",
                                  fecha: fecha,
                                  usuario: usuario,
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_firebase_service__WEBPACK_IMPORTED_MODULE_3__["FirebaseService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"], _services_utils_service__WEBPACK_IMPORTED_MODULE_7__["UtilsService"], _services_unique_service__WEBPACK_IMPORTED_MODULE_8__["UniqueService"]])], CartPage);
    /***/
  },
  ...
  function srcAppServicesUtilsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UtilsService = /*#__PURE__*/function () {
      ...
      _createClass(UtilsService, [{
        key: "difereciaEntreDosPuntos",
        value: function difereciaEntreDosPuntos(lon1, lat1, lon2, lat2) {
    ...
    UtilsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], UtilsService);
    /***/
  }
}]);
