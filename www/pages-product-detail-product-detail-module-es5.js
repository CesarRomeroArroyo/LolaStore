...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-detail-product-detail-module"], {
  ...
  function srcAppPagesProductDetailProductDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductDetailPage = /*#__PURE__*/function () {
      function ProductDetailPage(route, firebaseSvc, router, state) {
      ...
      _createClass(ProductDetailPage, [{
        ...
        value: function adicionar() {
          if (this.cantidad >= this.producto.cantidad) {} else {
            this.cantidad++;
          }
        }
      }, {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_firebase_service__WEBPACK_IMPORTED_MODULE_3__["FirebaseService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_state_service__WEBPACK_IMPORTED_MODULE_4__["StateApp"]])], ProductDetailPage);
    /***/
  }
}]);
